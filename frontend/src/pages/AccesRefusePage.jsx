...
import { Ban, House } from 'lucide-react';
  ...
  return (
    <div style={{ minHeight:'100vh', background:'var(--bg)', display:'flex', alignItems:'center', justifyContent:'center' }}>
      <div style={{ textAlign:'center', maxWidth:'400px', padding:'32px' }}>
        <div style={{ fontSize:'64px', marginBottom:'16px' }}><Ban size={64} aria-hidden='true' /></div>
        ...
        <Link to={homeRoute()} style={{ background:'var(--accent)', color:'white', padding:'10px 24px', borderRadius:'10px', fontWeight:700, fontSize:'14px', textDecoration:'none', display:'inline-block' }}>
          <House size={14} aria-hidden='true' />Retour à l'accueil
                  </Link>
      </div>
    </div>
  );
